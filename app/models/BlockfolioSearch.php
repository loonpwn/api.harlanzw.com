 ...
 */
class BlockfolioSearch extends WPPost {

    const MESSAGE_TYPE = '';

    const SLUG = 'blockfolio-search';
    ...
    private static function setup_cpt() {
        ...
        $args = [
            'labels'              => [
                'name' => esc_html__('BlockfolioSearch', 'wpestate'),
                'singular_name' => esc_html__('BlockfolioSearch', 'wpestate'),
            ],
