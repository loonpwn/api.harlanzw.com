...
class Wordpress_Plugin_Index extends WPES_Abstract_Index_Builder {
    ...
    public function get_mappings($args = []) {
        ...
        $post_mapping = array(
            ...
            'properties' => array(
                ...
                'slug_text' => $mappings->text_plus_ngram(),

                'plugin_modified' => $mappings->datetime_stored(),
                ...
                'author' => $mappings->primitive('string'),
                'contributors' => $mappings->primitive('string'),

                'all_content_en' => $mappings->text_plus_ngram(),
                'title_en' => $mappings->text_plus_ngram(),
                'excerpt_en' => $mappings->text_plus_ngram(),
                'description_en' => $mappings->text_plus_ngram(),
    ...
    public function get_doc_callbacks() {
        return array(
            'plugin' => 'Jetpack_Search_v2_Post_Doc_Builder',
        );
    }

}

class Plugin_Doc_Builder extends WPES_Abstract_Document_Builder {
...
//		$geo_data = $post_fld_bldr->geo( $post );
    ...
    public function concat_all_content($args) {
        $fld_bldr = new WPES_WP_Post_Field_Builder();
